      ...
      <div className="container mx-auto px-4 py-16">
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-8 max-w-4xl mx-auto">
          <div className="bg-white p-8 rounded-2xl shadow-lg hover:shadow-xl transition-shadow">
            ...
            <p className="text-gray-500">Track your daily wellness and build healthy habits</p>
          </div>
          <div className="bg-white p-8 rounded-2xl shadow-lg hover:shadow-xl transition-shadow">
            <h2 className="text-2xl font-semibold text-green-600 mb-4">Studio</h2>
            <p className="text-gray-500">Book appointments with beauty professionals</p>
          </div>
          <div className="bg-white p-8 rounded-2xl shadow-lg hover:shadow-xl transition-shadow">
            <h2 className="text-2xl font-semibold text-green-600 mb-4">Store</h2>
            <p className="text-gray-500">Shop wellness and beauty products</p>
          </div>
        </div>
      </div>
    </main>
